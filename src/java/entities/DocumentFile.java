...
@NamedQueries({
    ...
    @NamedQuery(name = "DocumentFile.findByInserted", query = "SELECT d FROM DocumentFile d WHERE d.inserted = :inserted")})
public class DocumentFile implements Serializable {
    ...
    public DocumentFile(Integer id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "entities.DocumentFile[ id=" + id + " ]";
    }
